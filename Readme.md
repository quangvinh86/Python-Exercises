...
Phần code mình sẽ làm để hết vào một function, cái nào ngắn quá thì dùng luôn trong hàm main
Function này sẽ được gọi từ hàm main(). Giống như ví dụ dưới đây: 
...
At the time I started learning Python by myself, the habit of learning programming languages was to do a lot of things.
By google, I  "picked up" the secret "martial arts" of Chinese friends with subject only.
Now, every exercises in "martial arts" were solved by Python2. 
But...I like to do it (like a bos) :))
